    ...
    <div class="box-right">
        ...
        <div class="select-filter">
            ...
            <select name="selectpicker" class="selectpicker2" onchange="location.href=document.location.href.replace(/\&\/.*/, '&') + '/' + this.value">
                ...
                <option value="popularity" @if($sortby == 'popularity') selected @endif>{{ __('messages.popularity') }}</option>
                <option value="lowerprice" @if($sortby == 'lowerprice') selected @endif>{{ __('messages.from low price') }}</option>
